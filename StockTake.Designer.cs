namespace QHMobile
{
    partial class StockTake
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.mnuItemOpt.MenuItems.Add(this.mnuBackup);
            this.mnuItemOpt.MenuItems.Add(this.mnuRestore);
            this.mnuItemOpt.MenuItems.Add(this.mnuDeleteAll);
